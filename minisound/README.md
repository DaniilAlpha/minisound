...
> \* This refers to platforms, for which apps can be actually compiled. E.g. Windows 7 support is dropped by Dart itself, so it technically cannot be supported.
